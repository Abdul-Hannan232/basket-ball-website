    ...
    return (
        <div>
            ...
            <div className='text-center mt-20 w-[90%] mx-auto shadow p-10 '>
                ...
                <p className='lg:w-[900px] mt-10 text-xl font-light  mx-auto '>At Basketball, we are more than just a basketball rental service; weare your go-to hoop haven for unleashing the spirit of the game. Whether you are a casual shooter or a seasoned baller, we have got the perfect court companion for you.</p>
            </div>
