    ...
    return (
        <div>
            ...
            <div className='text-center mt-20 w-[90%] mx-auto shadow p-10 '>
                ...
                <p className='lg:w-[900px] mt-10 text-xl font-light  mx-auto '>At Basketball, we are more than just a basketball rental service; we're your go-to hoop haven for unleashing the spirit of the game. Whether you are a casual shooter or a seasoned baller, we have got the perfect court companion for you.</p>
            </div>

            <div className='text-center mt-20 w-[90%] mx-auto shadow p-10 '>
                <p className='text-2xl text-[#FFA500] font-bold'>Our Mission: Hoops for Everyone</p>
                <p className='lg:w-[900px] mt-10 text-xl font-light  mx-auto '>Our mission is simple: to make the joy of basketball accessible to everyone. We believe in the power of the game to bring people together, inspire healthy competition, and create lasting memories. That's why wehave curated a top-notch selection of basketball equipment, ensuring that the love of the sport is just a rental away..</p>
            </div>
