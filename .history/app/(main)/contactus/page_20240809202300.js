    ...
    return (
        <div>
            ...
            <div className='md:my-40 my-28  md:mx-20 mx-5  rounded-2xl shadow md:p-20 md:p-8 p-3 '>
                ...
                <div className='mt-10 w-[100%] lg:flex items-center justify-center  gap-10'>
                    ...
                    <div className='bg-[#333333] flex items-center md:p-10 lg:mt-0 mt-10  md:gap-10 gap-5 shadow md:p-16 p-4 lg:w-[50%]'>
                        <div className='shadow bg-[#333333] p-3  md:w-20 md:h-20 w-16 h-16  rounded-md'>
