        ...
        <div>
            ...
            <div className='md:my-40 my-28  md:mx-20 mx-5  rounded-2xl shadow md:p-20 md:p-8 p-3 '>
                ...
                <div className='mt-10 lg:flex items-center justify-center  gap-20'>
                    <div className='bg-[#333333] flex items-center md:p-10 md:gap-10 shadow md:p-16 p-4 lg:w-[45%]'>
                        <div className='shadow bg-[#333333] p-3  w-20 h-20 rounded-md'>
                            <IoIosCall className='text-[#FFA500] text-6xl font-bold' />
                        </div>
                        <div>
                            <h1 className='text-[#FFA500] text-2xl font-bold'>Call Us</h1>
                            <p className='underline underline-offset-4 mt-2'>123-456-789</p>
                        </div>
                    </div>
                    <div className='bg-[#333333] lg:mt-0 mt-10 flex items-center p-10 gap-10 shadow p-16 lg:w-[45%]'>
                        <div className='shadow bg-[#333333] p-3  w-20 h-20 rounded-md'>
                            <AiTwotoneMessage className='text-[#FFA500] text-6xl font-bold' />
                        </div>
                        <div>
                            <h1 className='text-[#FFA500] text-2xl font-bold'> Message Us</h1>
