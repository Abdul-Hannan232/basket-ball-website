        ...
        <div>
            ...
            <div className='md:my-40 my-28  md:mx-20 mx-5  rounded-2xl shadow md:p-20 md:p-8 p-3 '>
                ...
                <div className='mt-10 flex items-center justify-center  gap-20'>
                    <div className='bg-[#333333] flex items-center p-10 gap-20 shadow p-16 w-[45%]'>
                        <div className='shadow bg-[#333333] p-3  w-16 h-16'>
                            <IoIosCall className='text-[#FFA500] text-4xl font-bold' />
                        </div>
                        <div>
                    ...
                    <div className='bg-[#333333] flex items-center p-10 gap-20 shadow p-16 w-[45%]'>
                        ...
                        <div>
                            <h1 className='text-[#FFA500] text-2xl font-bold'>Call Us</h1>
                            <p className='underline underline-offset-4 mt-3'>123-456-789</p>
                        </div>
                    </div>
                </div>
            </div>
