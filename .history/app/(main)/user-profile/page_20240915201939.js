                                ...
                                <div className=' my-10'>
                                    ...
                                    <div className='w-[90%] mx-auto grid grid-cols-2 gap-5 my-10'>
                                        <div >
                                            ...
                                            <input type='text' placeholder='Fred Khan' name="name" required value={formData.name} onChange={handleChange} className='text-black p-3 border-2  bg-[#808080] border-[#808080] outline-none w- mt-3 rounded-xl' />
                                        </div>
