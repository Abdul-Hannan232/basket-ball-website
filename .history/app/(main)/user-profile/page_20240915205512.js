                    ...
                    {activeTab === 'tab2' && <div>
                        <form onSubmit={handleSubmit}>
                            <div className='w-[60%] mx-auto space-y-5 my-10'>
                                ...
                                <button type="submit" className='bg-[#FFA500] p-3 w-full rounded-md  font-bold shadow-xl mx-auto text-black '>Save Changes</button>
                    ...
                    {activeTab === 'tab3' && <div>
                        ...
                        <div className='w-[60%]  mx-auto space-y-10 my-10'>
                            <form onSubmit={handleUpdatePassword} className='space-y-7' >
                                ...
                                <button type="submit" className='bg-[#FFA500] p-4 w-96 flex justify-center rounded-md  font-bold shadow-xl mx-auto text-black '>Change Password</button>
                            </form> </div>
