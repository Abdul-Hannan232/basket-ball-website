        ...
        <div>
            ...
            <h1 className='text-5xl font-bold mt-14 text-center'>Welcome, {formData.name}</h1>
                ...
                <div className="p-4">
                    ...
                    {activeTab === 'tab2' && <div>
                        <form onSubmit={handleSubmit}>
                            <div className='w-full0%]  mx-auto smdce-y-5 my-10'>
                                <div >
                                    <label className='text-white  text-md'> Team*</label><br />
                                    <input type='text' placeholder='City Hawks' name="team" value={formData.team} onChange={handleChange} className='shadow-xl text-black p-3 border-2  bg-[#808080] border-[#808080] outline-none w-full mt-3 rounded-md' />
                                </div>

                                <div >
                                    <label className='text-white  text-md'>Jersey Number  *</label><br />
                                    <input type='text' placeholder='23' name="jersey_number" value={formData.jersey_number} onChange={handleChange} className='text-black shadow-xl bg-[#808080]  p-3 border-2 border-[#808080] outline-none w-full mt-3 rounded-md' />
                                </div>
                                <div >
                                    <label className='text-white  text-md'>Position*</label><br />
                                    <input type='text' placeholder='Point Guard' name="position" value={formData.position} onChange={handleChange} className='text-black shadow-xl p-3 border-2  bg-[#808080] border-[#808080] outline-none w-full mt-3 rounded-md' />
                                </div>
