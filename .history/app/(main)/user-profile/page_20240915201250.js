            ...
            <h1 className='text-5xl font-bold mt-14 text-center'>Welcome, {formData.name}</h1>
                ...
                <div className="flex mt-32">
                    <button
                        ...
                        className={`py-2 px-7 font text-xl ${activeTab === 'tab1' ? 'border-b-2  border-[#FFA500] text-white' : 'text-gray-500'}`}
                    >
                        Personal Info                    </button>
                    <button
                        onClick={() => handleTabClick('tab2')}
                        className={`py-2 px-7 font text-xl ${activeTab === 'tab2' ? 'border-b-2  border-[#FFA500] text-white' : 'text-gray-500'}`}
                    >
                        Team Info
                    </button>
                    <button
                        onClick={() => handleTabClick('tab3')}
                        className={`py-2 px-7 font text-xl ${activeTab === 'tab3' ? 'border-b-2  border-[#FFA500] text-white' : 'text-gray-500'}`}
                    >
                        Password
                    </button>
                </div>
