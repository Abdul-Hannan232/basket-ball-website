                                ...
                                <div className=' my-10'>
                                    ...
                                    <div className='w-[100%] mx-auto grid grid-cols-2 gap-5 my-10'>
                                        <div >
                                            ...
                                            <input type='text' placeholder='Fred Khan' name="name" required value={formData.name} onChange={handleChange} className='text-black p-3 border-2  bg-[#808080] border-[#808080] outline-none w-[100%] mt-3 rounded-md' />
                                        </div>

                                        <div >
                                            <label className='text-white font-bold text-md'>Email  *</label><br />
                                            <input type='text' placeholder='info@centralparknyc.com' disabled value={formData.email} className='text-black bg-[#808080]  p-3 border-2 border-[#808080] outline-none w-full mt-3 rounded-md' />
                                        </div>
                                        <div >
                                            <label className='text-white font-bold text-md'>Contact*</label><br />
                                            <input type='text' placeholder='12345678' name="phone_number" value={formData.phone_number} onChange={handleChange} className='text-black p-3 border-2  bg-[#808080] border-[#808080] outline-none w-full mt-3 rounded-md' />
                                        </div>
                                        <div >
                                            <label className='text-white font-bold text-md'>Height*</label><br />
                                            <input type='text' placeholder='6 feet' name="height" required value={formData.height} onChange={handleChange} className='text-black p-3 border-2 bg-[#808080]  border-[#808080] outline-none w-full mt-3 rounded-md' />
                                        </div>
                                        <div >
                                            <label className='text-white font-bold text-md'>Weight*</label><br />
                                            <input type='text' placeholder='180 lbs' name="weight" required value={formData.weight} onChange={handleChange} className='text-black p-3 border-2 bg-[#808080]  border-[#808080] outline-none w-full mt-3 rounded-md' />
                                        </div>

                                        <div >
                                            <label className='text-white font-bold text-md'>Address</label><br />
                                            <input type='text' placeholder='123 street anytown' name="address" required value={formData.address} onChange={handleChange} className='text-black p-3  bg-[#808080] border-2 border-[#808080] outline-none w-full mt-3 rounded-md' />
                                        </div>
