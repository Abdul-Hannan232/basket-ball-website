    ...
    <>
      ...
      <div className='flex bg-white lg:mt-16 mt-14 lg:w-[81.5%] h-screen float-right text-black'>
        <div className='w-screen'>
          <div className='lg:p-5 p-2 m-5 lg:rounded-xl rounded-md border-2 lg:h-24  border-[#CACACA] lg:gap-10 gap-3 flex items-center'>
            <div className='w-full'>
              <input
                type='text'
                placeholder='Search Users'
                onChange={handleFilter}
                className='border border-[#CACACA] rounded-xl lg:p-4 p-2 bg-[#FFF8B3] w-full'
              />
            </div>
