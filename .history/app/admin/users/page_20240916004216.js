    ...
    <>
      ...
      <div className='flex bg-white lg:mt-16 mt-14 lg:w-[81.5%] h-screen float-right text-black'>
        <div className='w-screen'>
          <div className='p-5 m-5 rounded-xl border-2 h-24 border-[#CACACA] gap-10 lg:flex items-center'>
            ...
            <button className='bg-[#FFA500] text-white rounded-xl lg:mt-0 mt-14 p-4 text-xl w-60 text-center'>
