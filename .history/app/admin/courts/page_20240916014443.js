    ...
    <div>
      ...
      <div className='flex bg-white lg:mt-16 mt-14 lg:w-[81.5%] h-screen float-right text-black'>
        <div className='w-screen'>
          <div className='lg:p-5 p-2 m-5 lg:rounded-xl border-2 lg:h-24 border-[#CACACA] lg:gap-10 gap-2 flex items-center'>
            <div className='w-full relative'>
              <input
                type='text'
                placeholder='Search Courts'
                onChange={handleFilter}
                className='border border-[#CACACA] lg:text-lg text-sm lg:rounded-xl rounded-md lg:p-4 p-3 bg-[#FFF8B3] relative w-full'
              />
              <Image src="/filter-search.png" alt="filter" width="5" height="5" className="absolute lg:w-[25px] lg:h-[25px] w-5 h-5 top-4 right-3 lg:right-5" />
            </div>
