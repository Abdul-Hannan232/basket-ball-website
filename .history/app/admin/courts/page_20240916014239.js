          ...
          <div className='lg:p-5 p-1 m-5 rounded-xl border-2 h-24 border-[#CACACA] lg:gap-10 gap-2 flex items-center'>
            <div className='w-full relative'>
              <input
                ...
                className='border border-[#CACACA] lg:rounded-xl rounded-md lg:p-4 p-3 bg-[#FFF8B3] relative w-full'
              />
              <Image src="/filter-search.png" alt="filter" width="25" height="25" className="absolute top-4 right-5" />
            </div>
            <button className='bg-[#FFA500] text-white lg:rounded-xl rounded-md p-3 lg:text-xl text-[10px] lg:w-60 w-26  text-center'>
