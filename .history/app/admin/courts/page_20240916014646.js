                  ...
                  body={(rowData) => (
                    rowData.isactive ?
                      <div style={{ display: 'flex', color: "#818181", justifyContent: 'space-around' }}>
                        <Button icon={<FontAwesomeIcon icon={faEye} />} className="p-button-rounded p-button-info lg:text-lg" onClick={() => openBlockUserPopup(rowData)} />
                      </div>
                      : <div style={{ display: 'flex', color: "#818181", justifyContent: 'space-around' }}>
                        <Button icon={<FontAwesomeIcon icon={faEye} />} className="p-button-rounded p-button-info lg:text-lg" onClick={() => blockUser(rowData)} />
                      </div>
                  )}
