    ...
    return (
        <div className='bg-[#FFA500] sticky top-0 left-0 right-0 p-4 flex z-40 items-center justify-between'>
            ...
            {loggedInUser ? (
                    ...
                    height={50}
                />
<Image src="/Vector.png" alt="image" width={20} height={20}/>                        <h3 className="text-2xl font-bold text-gray-800 border-b-2 border-blue-500 pb-2 shadow-lg hover:text-blue-500 transition duration-300">
                            {loggedInUser.name}
                        </h3>
