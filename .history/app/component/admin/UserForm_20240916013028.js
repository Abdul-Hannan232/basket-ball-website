                            ...
                            <div className='lg:flex items-center justify-between gap-10 px-3'>
                                <div className='lg:flex items-center gap-10 p-5'>
                                    <Image
                                        ...
                                        width={140}
                                        height={140}
                                        className='w-40 h-40 rounded-full lg:mx-0 mxshadow-xl'
                                    />
                                    <div>
                    ...
                    <div className='border border-[#CACACA] m-5 rounded-xl mt-20'>
                        ...
                        <div className='lg:w-[80%] w-[90%] mx-auto grid lg:grid-cols-2 grid-cols-1 justify-between gap-10 mt-10'>
                            <div >
                                ...
                                <input type='text' name="team" value={formData.team} onChange={handleChange} placeholder='Hoop Dreamers' className='text-black p-3 border-2 border-[#CACAC] w-full lg:w-96 mt-3 rounded-xl' />
                            </div>
                            <div >
                            ...
                            <div >
                                ...
                                <input type='text' name="position" value={formData.position} onChange={handleChange} placeholder='Point Guard' className='text-black p-3 border-2 border-[#CACAC] w-full lg:w-96 mt-3 rounded-xl' />
                            </div>
                        </div>
