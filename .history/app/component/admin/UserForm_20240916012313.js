            ...
            <div className='w-screen lg:mt-0 mt-10'>
                <form onSubmit={handleSubmit}>
                    <div className='border border-[#CACACA] m-5 rounded-xl m-5'>
                        ...
                        <div className='lg:w-[80%] w-[] mx-auto grid lg:grid-cols-2 grid-cols-1  gap-5 my-20'>
                            <div >
                            ...
                            <div >
                                ...
                                <input type='date' name="joined_since" required value={DateFormat(formData.joined_since)} onChange={handleChange} placeholder='01/02/17' className='text-black p-3 border-2 border-[#CACAC] lg:w-96 mt-3 rounded-xl' />
                            </div>
                            <div >
