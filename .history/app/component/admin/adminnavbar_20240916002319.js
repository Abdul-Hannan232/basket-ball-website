...
const Adminnavbar = () => {
    ...
    return (
        <div className='bg-[#FFA500] flex items-center justify-between fixed top-0 right-0 left-0 px-5  '>
            <div className=' p-4 lg:pl-7 pl-3 flex items-center text-white'>
                <h1 className='lg:text-3xl text-lg font-bold'>Basketball</h1>
                <div className='border-2 border-y-transparent border-r-transparent lg:mx-20  lg:pl-5 pl-2 border-white'>
