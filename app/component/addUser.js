                ...
                <div className='border border-[#CACACA] m-5 rounded-xl m-5'>
                    ...
                    <div className='w-[80%] mx-auto grid grid-cols-2 gap-5 my-20'>
                        <div >
                            ...
                            <input type='text' name="name" value={formData.name} onChange={handleChange} placeholder='John Doe' className='text-black p-3 border-2 border-[#CACAC] w-96 mt-3 rounded-xl'  />
                        </div>
                        <div >
                            <label className='text-black font-bold text-md'>First Name  *</label><br />
                            <input type='text'  name="first_name" value={formData.first_name} onChange={(e)=>handleChange(e)}  placeholder='John' className='text-black p-3 border-2 border-[#CACAC] w-96 mt-3 rounded-xl' />
                        </div>
                        <div >
                            <label className='text-black font-bold text-md'>Email  *</label><br />
                            <input type='text' name="email" value={formData.email} onChange={handleChange}  placeholder='info@centralparknyc.com' className='text-black p-3 border-2 border-[#CACAC] w-96 mt-3 rounded-xl' />
                        </div>
                        <div >
                            <label className='text-black font-bold text-md'>Last Name*</label><br />
                            <input type='text' name="last_name" value={formData.last_name} onChange={handleChange} placeholder='Doe' className='text-black p-3 border-2 border-[#CACAC] w-96 mt-3 rounded-xl' />
                        </div>
                        <div >
                            <label className='text-black font-bold text-md'>Height*</label><br />
                            <input type='text' name="height" value={formData.height} onChange={handleChange} placeholder='190 cm' className='text-black p-3 border-2 border-[#CACAC] w-96 mt-3 rounded-xl' />
                        </div>
                        <div >
                            <label className='text-black font-bold text-md'>Weight*</label><br />
                            <input type='text' name="weight" value={formData.weight} onChange={handleChange} placeholder='110 KG' className='text-black p-3 border-2 border-[#CACAC] w-96 mt-3 rounded-xl' />
                        </div>
                        <div >
                        ...
                        <div >
                            ...
                            <input type='date'name="joined_since" value={formData.joined_since} onChange={handleChange} placeholder='01/02/17' className='text-black p-3 border-2 border-[#CACAC] w-96 mt-3 rounded-xl' />
                        </div>
                        <div >
                            <label className='text-black font-bold text-md'>Country*</label><br />
                            <input type='text' name="country" value={formData.country} onChange={handleChange} placeholder='USA' className='text-black p-3 border-2 border-[#CACAC] w-96 mt-3 rounded-xl' />
                        </div>
                        <div >
                            <label className='text-black font-bold text-md'>Role*</label><br />
                            <input type='text' name="role" value={formData.role} onChange={handleChange}  placeholder='Admin' className='text-black p-3 border-2 border-[#CACAC] w-96 mt-3 rounded-xl' />
                        </div>
