                ...
                <form className=' md:w-[450px] w-full mx-auto space-y-4' onSubmit={handleSubmit}>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <input type='text' placeholder='Enter your email ' value={email}
                            ...
                            className='mt-1  cursor-pointer shadow-xl outline-none border-[#808080] border text-white rounded-lg bg-[#808080] p-4' />
                        <br /> <label className='text-sm'>Password</label>
                        <input type='password' placeholder='Enter your Password ' required onChange={(e) => setPassword(e.target.value)} value={password} className='mt-1 cursor-pointer shadow-xl ouline-none border-[#808080] border text-white rounded-lg bg-[#808080] p-4' />
                    </div>
                    <div className='text-sm flex items-center justify-between '>
                        <div className='flex items-center gap-2'>
                            <input type='checkbox' className='w-5 h-5 cursor-pointer bg-[#808080]' checked={rememberMe}
                    ...
                    <button type='submit' className='border-[#FFA500] w-full text-xl border text-white rounded-lg bg-[#FFA500] p-4 shadow-xl cursor-pointer'>Login</button>
                    <Link href="/signup">
                        <button className='border bg-[#333333] w-full text-xl border shadow-xl text-white rounded-lg mt-4 p-4 cursor-pointer'>Sign Up</button>
                    </Link>
                    ...
                    <div className='border bg-[#333333] w-full text-xl border text-white rounded-lg cursor-pointer p-4  flex items-center justify-center shadow-xl gap-2' onClick={() => signIn("google")}><FcGoogle className='text-3xl ' />Login with Google</div>
