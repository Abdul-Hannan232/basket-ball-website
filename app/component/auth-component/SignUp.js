        ...
        <>
            ...
            <div className='flex  justify-between md:mx-0 mx-5 items-center min-h-screen'>
                <form className=' md:w-[450px] w-full mx-auto space-y-4' onSubmit={handleSubmit}>
                    ...
                    <div className='border bg-[#333333] w-full md:text-xl text-md border text-white rounded-lg cursor-pointer p-3  flex items-center justify-center gap-2' onClick={() => signIn("google")} ><FcGoogle className='md:text-3xl text-xl ' />Login with Google</div>
